...
| `schematic-drawing-standards.md` | — | **Read before creating/redrawing any schematic.** LM5013-style layout standard: power bus, GND bus, label policy, KiCad 9 wiring rules, EasyEDA handoff, verification gate |
